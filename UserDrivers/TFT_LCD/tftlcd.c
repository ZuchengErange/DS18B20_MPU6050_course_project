...
//LCD的画笔颜色和背景色	   
uint16_t 	lcdFRONT_COLOR=lcdColor_WHITE;	//画笔颜色
...
uint16_t LCD_CurPosX=0;	//当前位置X
uint16_t LCD_CurPosY=0;	//当前位置Y
...
//显示无符号整数,传递进来的书num可以是 uint8_t, uint16_t, uint32_t
